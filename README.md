...
-> print(ncp.pal_show("nom de la palette"))
...
ax.contourf peut-être remplacer par d'autres fonctions de visualisations. 
x, y, et z sont à remplacer par le nom des variables à visualiser.
---
